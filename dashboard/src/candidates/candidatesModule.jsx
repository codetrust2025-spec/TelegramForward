  ...
  w.useEffect(() => {
    const timer = setTimeout(() => {
      ...
      rows.forEach((row, index) => {
        ...
        // Match candidate by data-cid attribute (most reliable)
        const rowCid = row.getAttribute("data-cid") || "";
        const candidate = rowCid ? sortedCandidates.find(c => c && c.id === rowCid) : sortedCandidates[index];
