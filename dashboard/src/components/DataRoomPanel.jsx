...
function CredentialsSection({ creds, loading }) {
  ...
  return (
    <section className="dr-section dr-credentials-section" aria-labelledby="dr-creds-title">
      <div className="dr-section-head">
        <h2 id="dr-creds-title" className="dr-section-title">Credentials</h2>
        <p className="dr-section-desc">
          Part of the data room — dashboard logins for admin and handlers. Use Copy on each row (user, password, or full login).
        </p>
      </div>
...
export function DataRoomPanel() {
  ...
  return (
    <div className="cand-page dr-page">
      <header className="cand-header">
        <div className="cand-header-titles">
          ...
          <p className="cand-subtitle">
            Two sections: <strong>Credentials</strong> (dashboard logins, admin only) and{' '}
            <strong>Business opportunities</strong> (partner contact details for future alignment).
          </p>
        </div>
      ...
      {isAdmin && (
        <CredentialsSection creds={credentials} loading={credsLoading} />
      )}

      <section className="dr-section dr-partners-section" aria-labelledby="dr-partners-title">
        <div className="dr-section-head">
          <h2 id="dr-partners-title" className="dr-section-title">Business opportunities</h2>
          <p className="dr-section-desc">
      ...
      {loading && <p className="dr-muted">Loading…</p>}
